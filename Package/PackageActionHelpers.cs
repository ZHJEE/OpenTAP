...
namespace OpenTap.Package
{
    internal static class PackageActionHelpers
    {
        ...
        internal static PackageDef FindPackage(PackageSpecifier packageReference, Installation installation, List<IPackageRepository> repositories)
        {
        ...
        internal static List<PackageDef> GatherPackagesAndDependencyDefs(Installation installation, string[] packageNames, string Version, CpuArchitecture arch, string OS, List<IPackageRepository> repositories, bool includeDependencies, bool askToIncludeDependencies)
        {
            ...
            foreach (var packageReference in packages)
            {
                ...
                {
                    PackageDef package = PackageActionHelpers.FindPackage(packageReference, installation, repositories);
