...
namespace OpenTap.Package
{
    ...
    public class PackageDef : PackageIdentifier
    {
        ...
        /// This method is obsolete, please use <see cref="PackageDef.PackageRepositoryUrl"/> or <see cref="PackageDef.DownloadUrl"/>.
        /// </summary>
        [XmlElement("PackageRepositoryUrl")]
        [DefaultValue(null)]
        [Obsolete("Use 'PackageRepositoryUrl' or 'DownloadUrl' instead.")]
        ...
        public static PackageDef FromPackage(string path)
        {
            ...
            pkgDef.DownloadUrl = Path.GetFullPath(path);
            return pkgDef;
        }
