...
namespace OpenTap.Package.UnitTests
{
    ...
    public class PackageDefTests
    {
        ...
        /// <summary>
        /// This test requires that TAP is installed along with the XSeries and QualcommFemto plugin
        /// </summary>
        [Test]
        public void CheckDependencies_AllDepsInstalled()
        {
            ...
            var xseries = PackageDef.FromXmlFile(Path.Combine(PackageDef.PackageDefDirectory, "XSeries.package.xml"));
            var qcfemto = PackageDef.FromXmlFile(Path.Combine(PackageDef.PackageDefDirectory, "QualcommFemto.package.xml"));
        ...
        public void InstalledPackages_TwoPackages()
        {
            ...
            Assert.IsTrue(File.Exists(Path.Combine(PackageDef.PackageDefDirectory, "QualcommFemto.package.xml")), "Necessary package file missing.");
            ...
            Assert.IsTrue(target.Any(pkg => pkg.Name == "QualcommFemto"));
        }
