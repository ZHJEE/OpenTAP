...
namespace OpenTap.Package.UnitTests
{
    ...
    public class PackageDefTests
    {
        ...
        /// <summary>
        /// This test requires that OpenTAP is installed along with the XSeries and QualcommFemto plugin
        /// </summary>
        [Test]
        public void CheckDependencies_AllDepsInstalled()
        {
            ...
            var xseries = PackageDef.FromXml(PackageDef.GetDefaultPackageMetadataPath("XSeries"));
            var qcfemto = PackageDef.FromXml(PackageDef.GetDefaultPackageMetadataPath("QualcommFemto"));
        ...
        public void InstalledPackages_TwoPackages()
        {
            ...
            Assert.IsTrue(File.Exists(PackageDef.GetDefaultPackageMetadataPath("QualcommFemto")), "Necessary package file missing.");
