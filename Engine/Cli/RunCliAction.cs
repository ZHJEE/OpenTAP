...
namespace OpenTap.Cli
{
    ...
    {
        /// <summary>
        /// Specify a bench settings profile from which to load\nsettings. The parameter given here should correspond to the name of a subdirectory of %TAP_DIR%/Settings/Bench. If not specified the settings from OpenTAP GUI are used.
        /// </summary>
        [CommandLineArgument("settings", Description = "Specify a bench settings profile from which to load\nsettings. The parameter given here should correspond\nto the name of a subdirectory of %TAP_DIR%/Settings/Bench.\nIf not specified, %TAP_DIR%/Settings/Bench/CurrentProfile is used.")]
